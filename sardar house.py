...
@app.route('/about')
def about():
    content = '<div class="card-premium py-4"><h2>আমাদের সম্পর্কে</h2><p>Sardar House একটি প্রিমিয়াম লাইফস্টাইল ব্র্যান্ড। আমরা সরাসরি কাস্টমারদের হাতে সেরা মানের পণ্য পৌঁছে দিতে কাজ করি।</p></div>'
